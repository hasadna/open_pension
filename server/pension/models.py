...
class Instrument(models.Model):
    ...
    rate_of_fund = models.DecimalField(_('Rate Of Fund'), help_text="This is a percentage value.", validators=[validate_percentage], max_digits=50, decimal_places=3, null=True)
    ...
    rate_of_ipo = models.DecimalField(_('Rate Of IPO'), help_text="This is a percentage value.", validators=[validate_percentage], max_digits=50, decimal_places=3, null=True)
    informer = models.CharField(_('Informer'), max_length=255, blank=True)
    fair_value = models.DecimalField(_('Fair Value'), help_text="Value is in thousands.", max_digits=50, decimal_places=3, null=True)
    ...
    return_on_equity = models.DecimalField(_('Return On Equity'), help_text="This is a percentage value.", validators=[validate_percentage], max_digits=50, decimal_places=3, null=True)
    liabilities = models.DecimalField(_('Liabilities'), help_text="Value is in thousands.", max_digits=50, decimal_places=3, null=True)
    expiry_date_of_liabilities = models.DateField(_('Expiry Date Of Liabilities'))
    effective_rate = models.DecimalField(_('Effective Rate'), help_text="This is a percentage value.", validators=[validate_percentage], max_digits=50, decimal_places=3, null=True)
    coordinated_cost = models.DecimalField(_('Coordinated Cost'), help_text="Value is in thousands.", max_digits=50, decimal_places=3, null=True)
    ...
    average_rate = models.DecimalField(_('Average Rate'), help_text="This is a percentage value.", validators=[validate_percentage], max_digits=50, decimal_places=3, null=True)
    par_value = models.DecimalField(_('Par Value'), help_text="Value is in thousands.", max_digits=50, decimal_places=3, null=True)
