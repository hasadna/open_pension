...
from pension.choices import (YEARS, MONTHS, MANAGING_BODIES, INSTRUMENT_TYPES, INSTRUMENT_FIELDS, INSTRUMENT_SUB_TYPES,
                             RATING)
...
class Fund(models.Model):
    ...
    instrument_id = models.IntegerField(_('Instrument Id'))
    orig_instrument_id = models.CharField(_('Original Instrument Id'), max_length=255, blank=True)
    ...
    reference_index = models.CharField(_('Reference Index'), max_length=255, blank=True)
    ...
    liquidity = models.CharField(_('Liquidity'), max_length=255, blank=True)
    asset_type = models.CharField(_('Asset Type'), max_length=255, blank=True)
    row_cleansing_time = models.DateField(_('Row Cleansing Time'), null=True, blank=True)
    issuer_number = models.IntegerField(_('Issuer Number'), null=True, blank=True)
    owner_option = models.CharField(_('Owner Option'), max_length=255, blank=True)
    original_issuer_number = models.IntegerField(_('Original Issuer Number'), null=True, blank=True)
    isin = models.CharField(_('ISIN'), max_length=255, blank=True)
    instrument_symbol = models.CharField(_('Instrument Symbol'), max_length=255, blank=True)
    movil = models.CharField(_('Movil'), max_length=255, blank=True)
