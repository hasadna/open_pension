    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fields_to_show', models.CharField(choices=[('currency', 'Currency'), ('informer', 'Informer'), ('activity_industry', 'Activity Industry'), ('type_of_asset', 'Type Of Asset'), ('consortium', 'Consortium'), ('managing_body', 'Managing Body'), ('geographical_location', 'Geographical Location'), ('instrument_sub_type', 'Instrument Sub Type')], max_length=255, verbose_name='Fields To Show')),
