...
def create_blog_dummy_data():
    ...
    Blog.objects.get_or_create(
        ...
        body='זוהי עובדה מבוססת שדעתו של הקורא תהיה'
             'מוסחת על ידי טקטס קריא כאשר הוא יביט בפריסתו. המטרה בשימוש ב-Lorem Ipsum הוא שיש לו פחות או'
             'יותר תפוצה של אותיות, בניגוד למלל יסוי יסוי יסוי, ונותן חזות קריאה יותר.הרבה הוצאות מחשבים ועורכי דפי'
             'אינטרנט משתמשים כיום ב-Lorem Ipsum כטקסט ברירת המחדל שלהם, וחיפוש של lorem ipsum יחשוף אתרים'
             'רבים בראשית דרכם.גרסאות רבות נוצרו במהלך השנים, לעתים בשגגה לעיתים במכוון (זריקת בדיחות וכדומה).',
        title_en='Lack of transparency in the publics assets portfolio',
        author_en='Open Pension Stuff',
        body_en='There are many variations of passages of Lorem Ipsum available, but the majority have'
                'suffered alteration in some form, by injected humour, or randomised words which dont look'
                'even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to'
                'be sure there isnt anything embarrassing hidden in the middle of text. All the Lorem Ipsum'
