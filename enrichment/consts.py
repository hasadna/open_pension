...
ISIN_INSTRUMENTS_LIST = [GOVERNMENTAL_BONDS, GOVERNMENTAL_BONDS_NT, COMPANY_BONDS, COMPANY_BONDS_NT, STOCKS, STOCKS_NT,
                         ETF, MUTUAL_FUNDS, MUTUAL_FUNDS_NT, WARRANTS, WARRANTS_NT, OPTIONS, OPTIONS_NT
...
INSTRUMENT_NAME_COLUMNS = [CASH, GOVERNMENTAL_BONDS, COMMERCIAL_BONDS, COMPANY_BONDS, STOCKS, ETF, MUTUAL_FUNDS,
                           WARRANTS, OPTIONS, FUTURES, STRUCTURED_PRODUCT, STOCKS_NT, GOVERNMENTAL_BONDS_NT,
...
INSTRUMENT_NUM_COLUMNS = [CASH, GOVERNMENTAL_BONDS, COMMERCIAL_BONDS, COMPANY_BONDS, STOCKS, ETF, MUTUAL_FUNDS,
                          WARRANTS, OPTIONS, FUTURES, STRUCTURED_PRODUCT, STOCKS_NT, GOVERNMENTAL_BONDS_NT,
                          COMMERCIAL_BONDS_NT, COMPANY_BONDS_NT, MUTUAL_FUNDS_NT, WARRANTS_NT, OPTIONS_NT,
                          FUTURES_CONTRACT_NT, STRUCTURED_PRODUCT_NT, LOANS, SECURITY_DEP_OVER_THREE_MONTHS,
                          OTHER_INVESTMENTS, COORDINATED_COST_COMPANY_BONDS, COORDINATED_COST_BORROWING_CREDIT]

MARKET_NAME_COLUMNS = [GOVERNMENTAL_BONDS, COMMERCIAL_BONDS, COMPANY_BONDS, STOCKS, ETF, MUTUAL_FUNDS, WARRANTS,
                       OPTIONS, FUTURES]

CURRENCY_COLUMNS = [CASH, GOVERNMENTAL_BONDS, COMMERCIAL_BONDS, COMPANY_BONDS, STOCKS, ETF, MUTUAL_FUNDS,
                    WARRANTS, OPTIONS, FUTURES, STRUCTURED_PRODUCT, STOCKS_NT, GOVERNMENTAL_BONDS_NT,
                    COMMERCIAL_BONDS_NT, COMPANY_BONDS_NT, MUTUAL_FUNDS_NT, WARRANTS_NT, OPTIONS_NT,
