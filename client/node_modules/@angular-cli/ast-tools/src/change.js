...
var MultiChange = (function () {
    ...
    MultiChange.prototype.apply = function () {
        return this._changes
            .sort(function (a, b) { return b.order - a.order; })
            .reduce(function (promise, change) {
            return promise.then(function () { return change.apply(); });
        }, Promise.resolve());
    };
    return MultiChange;
}());
...
var InsertChange = (function () {
     ...
     */
    InsertChange.prototype.apply = function () {
        var _this = this;
        return readFile(this.path, 'utf8').then(function (content) {
            var prefix = content.substring(0, _this.pos);
            var suffix = content.substring(_this.pos);
            return writeFile(_this.path, "" + prefix + _this.toAdd + suffix);
        });
    };
    return InsertChange;
}());
...
var RemoveChange = (function () {
    ...
    RemoveChange.prototype.apply = function () {
        var _this = this;
        return readFile(this.path, 'utf8').then(function (content) {
            var prefix = content.substring(0, _this.pos);
            var suffix = content.substring(_this.pos + _this.toRemove.length);
            // TODO: throw error if toRemove doesn't match removed string.
            return writeFile(_this.path, "" + prefix + suffix);
        });
    };
    return RemoveChange;
}());
...
var ReplaceChange = (function () {
    ...
    ReplaceChange.prototype.apply = function () {
        var _this = this;
        return readFile(this.path, 'utf8').then(function (content) {
            var prefix = content.substring(0, _this.pos);
            var suffix = content.substring(_this.pos + _this.oldText.length);
            // TODO: throw error if oldText doesn't match removed string.
            return writeFile(_this.path, "" + prefix + _this.newText + suffix);
        });
    };
    return ReplaceChange;
}());
exports.ReplaceChange = ReplaceChange;
//# sourceMappingURL=/Users/hansl/Sources/angular-cli/packages/ast-tools/src/change.js.map