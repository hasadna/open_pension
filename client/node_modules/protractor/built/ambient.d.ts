...
import {ActionSequence, By, WebDriver, WebElement, WebElementPromise, promise, promise as wdpromise, until} from 'selenium-webdriver';
export  class Webdriver {
    ...
    sleep: (ms: number) => wdpromise.Promise<any>;
    getCurrentUrl: () => wdpromise.Promise<any>;
    getTitle: () => wdpromise.Promise<any>;
...
export  class ProtractorBrowser extends Webdriver {
     ...
     */
    static wrapDriver(webdriver: any, baseUrl?: string, rootElement?: string, untrackOutstandingTimeouts?: boolean): ProtractorBrowser;
}
...
export  class WebdriverWebElement {
    ...
    sendKeys: (...args: (string | promise.Promise<string>)[]) => promise.Promise<void>;
...
export  class ElementArrayFinder extends WebdriverWebElement {
    ...
    locator_: any;
    actionResults_: promise.Promise<any>;
    constructor(browser_: ProtractorBrowser, getWebElements?: () => promise.Promise<WebElement[]>, locator_?: any, actionResults_?: promise.Promise<any>);
    [key: string]: any;
    /**
     ...
     *     resolve to null.
     */
    each(fn: (elementFinder: ElementFinder, index: number) => any): promise.Promise<any>;
    /**
     ...
     */
    map(mapFn: (elementFinder: ElementFinder, index: number) => any): promise.Promise<any>;
    /**
...
export interface Locator {
    findElementsOverride?: (driver: WebDriver, using: WebElement, rootSelector: string) => promise.Promise<WebElement[]>;
...
export interface ProtractorPlugin {
     ...
     */
    postTest?: (passed: boolean, testInfo: any) => any;
    /**
...
export  class Ptor {
    ...
    By: ProtractorBy;
    by: ProtractorBy;
    wrapDriver: (webdriver: any, baseUrl?: string, rootElement?: string, untrackOutstandingTimeouts?: boolean) => ProtractorBrowser;
