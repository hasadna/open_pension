...
var ModuleResolver = (function () {
     ...
     */
    ModuleResolver.prototype.applySortedChangePromise = function (changes) {
        return changes
            .sort(function (currentChange, nextChange) { return nextChange.order - currentChange.order; })
            .reduce(function (newChange, change) { return newChange.then(function () { return change.apply(); }); }, Promise.resolve());
    };
    /**
...
//# sourceMappingURL=/Users/hans/Sources/angular-cli/packages/angular-cli/angular-cli/utilities/module-resolver.js.map