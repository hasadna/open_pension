...
/**
 * Provides a list controller for the manager entity type.
 */
class ManagerListBuilder extends EntityListBuilder {
  ...
  /**
   * Constructs a new ManagerListBuilder object.
   *
  ...
  public function render() {
    ...
    $build['summary']['#markup'] = $this->t('Total managers: @total', ['@total' => $total]);
    return $build;
  }
