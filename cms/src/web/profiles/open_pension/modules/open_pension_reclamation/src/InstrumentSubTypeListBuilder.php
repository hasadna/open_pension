...
/**
 * Provides a list controller for the instrument sub type entity type.
 */
class InstrumentSubTypeListBuilder extends EntityListBuilder {
  ...
  /**
   * Constructs a new InstrumentSubTypeListBuilder object.
   *
  ...
  public function render() {
    ...
    $build['summary']['#markup'] = $this->t('Total instrument sub types: @total', ['@total' => $total]);
    return $build;
  }
