 ...
 *   },
 *   links = {
 *     "add-form" = "/admin/content/instrument/add",
 *     "canonical" = "/instrument/{instrument}",
 *     "edit-form" = "/admin/content/instrument/{instrument}/edit",
 *     "delete-form" = "/admin/content/instrument/{instrument}/delete",
 *     "collection" = "/admin/content/instrument"
 *   },
 * )
 */
class Instrument extends ContentEntityBase implements InstrumentInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['created'] = BaseFieldDefinition::create('created')
      ...
      ->setDescription(t('The time that the instrument was created.'))
      ->setDisplayOptions('view', [
        'label' => 'above',
        'type' => 'timestamp',
        'weight' => 20,
    ...
    $fields['changed'] = BaseFieldDefinition::create('changed')
      ->setLabel(t('Changed'))
      ->setDescription(t('The time that the instrument was last edited.'));
