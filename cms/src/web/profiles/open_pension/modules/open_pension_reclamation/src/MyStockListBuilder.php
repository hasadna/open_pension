...
/**
 * Provides a list controller for the my stock entity type.
 */
class MyStockListBuilder extends EntityListBuilder {
  ...
  /**
   * Constructs a new MyStockListBuilder object.
   *
  ...
  public function render() {
    ...
    $build['summary']['#markup'] = $this->t('Total my stocks: @total', ['@total' => $total]);
    return $build;
  }
