 ...
 *   },
 *   links = {
 *     "add-form" = "/admin/content/my-stock/add",
 *     "canonical" = "/my_stock/{my_stock}",
 *     "edit-form" = "/admin/content/my-stock/{my_stock}/edit",
 *     "delete-form" = "/admin/content/my-stock/{my_stock}/delete",
 *     "collection" = "/admin/content/my-stock"
 *   },
 * )
 */
class MyStock extends ContentEntityBase implements MyStockInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['created'] = BaseFieldDefinition::create('created')
      ...
      ->setDescription(t('The time that the my stock was created.'))
      ->setDisplayOptions('view', [
        'label' => 'above',
        'type' => 'timestamp',
        'weight' => 20,
    ...
    $fields['changed'] = BaseFieldDefinition::create('changed')
      ->setLabel(t('Changed'))
      ->setDescription(t('The time that the my stock was last edited.'));
