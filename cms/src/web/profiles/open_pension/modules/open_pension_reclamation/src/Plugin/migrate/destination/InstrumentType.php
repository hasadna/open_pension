...
namespace Drupal\open_pension_reclamation\Plugin\migrate\destination;
...
/**
 * The 'instrument_type' destination plugin.
 *
 * @MigrateDestination(
 *   id = "instrument_type"
 * )
 */
class InstrumentType extends DestinationBase implements ContainerFactoryPluginInterface {
