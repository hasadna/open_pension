 ...
 *   },
 *   links = {
 *     "add-form" = "/admin/content/market-date/add",
 *     "canonical" = "/market_date/{market_date}",
 *     "edit-form" = "/admin/content/market-date/{market_date}/edit",
 *     "delete-form" = "/admin/content/market-date/{market_date}/delete",
 *     "collection" = "/admin/content/market-date"
 *   },
 * )
 */
class MarketDate extends ContentEntityBase implements MarketDateInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['created'] = BaseFieldDefinition::create('created')
      ...
      ->setDescription(t('The time that the market date was created.'))
      ->setDisplayOptions('view', [
        'label' => 'above',
        'type' => 'timestamp',
        'weight' => 20,
    ...
    $fields['changed'] = BaseFieldDefinition::create('changed')
      ->setLabel(t('Changed'))
      ->setDescription(t('The time that the market date was last edited.'));
