...
-- AddForeignKey
ALTER TABLE `Fund` ADD FOREIGN KEY (`managingBodyID`) REFERENCES `ManagingBody`(`ID`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Fund` ADD FOREIGN KEY (`fundNameID`) REFERENCES `FundName`(`ID`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Fund` ADD FOREIGN KEY (`statusID`) REFERENCES `Status`(`ID`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Fund` ADD FOREIGN KEY (`channelID`) REFERENCES `Channel`(`ID`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Fund` ADD FOREIGN KEY (`subChannelID`) REFERENCES `SubChannel`(`ID`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Fund` ADD FOREIGN KEY (`typeID`) REFERENCES `Type`(`ID`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Fund` ADD FOREIGN KEY (`passiveActiveID`) REFERENCES `PassiveActive`(`ID`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Fund` ADD FOREIGN KEY (`homebaseID`) REFERENCES `Homebase`(`ID`) ON DELETE CASCADE ON UPDATE CASCADE;
