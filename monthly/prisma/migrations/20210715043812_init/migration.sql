...
-- AddForeignKey
ALTER TABLE `Row` ADD FOREIGN KEY (`managingBodyID`) REFERENCES `ManagingBody`(`ID`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Row` ADD FOREIGN KEY (`fundNameID`) REFERENCES `FundName`(`ID`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Row` ADD FOREIGN KEY (`statusID`) REFERENCES `Status`(`ID`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Row` ADD FOREIGN KEY (`channelID`) REFERENCES `Channel`(`ID`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Row` ADD FOREIGN KEY (`subChannelID`) REFERENCES `SubChannel`(`ID`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Row` ADD FOREIGN KEY (`typeID`) REFERENCES `Type`(`ID`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Row` ADD FOREIGN KEY (`passiveActiveID`) REFERENCES `PassiveActive`(`ID`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Row` ADD FOREIGN KEY (`homebaseID`) REFERENCES `Homebase`(`ID`) ON DELETE SET NULL ON UPDATE CASCADE;
